    ...
    <tr><td align="center">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #ece7df;">
        ...
        <tr><td style="padding:0 36px 8px 36px;">
          ...
          <p style="margin:0 0 28px 0;"><a href="${CALENDLY_LINK}" style="display:inline-block;background:#463acb;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:999px;font-weight:500;font-size:14px;">Book a 30-min call →</a></p>
        </td></tr>
